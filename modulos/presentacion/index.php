                    ...
                    <form id="formulario" method="post">
                        <input type="hidden" name="idpresentacion" id="idpresentacion"/>
                          ...
                          <div class="form-group row">
                            <label for="presentacion" class="col-sm-3 col-form-label">Presentación</label>
                            <div class="col-sm-9">
...
<script>
      ...
      function mover_pagina(pagina) {
        ...
        $("#listado").load("?modulo=presentacion&accion=listar",parametros);
    }
    ...
    function modificar(id) {
       ...
       $("#div-tabla").hide();
        ...
        $("#btn-agregar").hide();
        $("#btn-modificar").show();
            $(".entrada").text("Editar presentación ");


        //Limpiar el formulario
        $("#formulario").trigger("reset");
        var p = "id=" + id;
        $.get("?modulo=presentacion&accion=asignar", p, function(respuesta) {
            ...
            $("#idpresentacion").val(r.idpresentacion);
            $("#presentacion").val(r.presentacion);
    ...
    function eliminar(id) {
        ...
        if (confirm("¿Desea eliminar el registro?")) {
            var p = "idpresentacion=" + id;
            $.post("?modulo=presentacion&accion=eliminar", p, function(respuesta) {
                try {
                    var r = jQuery.parseJSON(respuesta);
    ...
    $("#btn-mostrar-formulario-agregar").click(function() {
        ...
        $("#btn-agregar").show();
        $("#btn-modificar").hide();
                    $(".entrada").text("Agregar presentación");
    ...
    $("#btn-agregar").click(function() {
        ...
        $.post("?modulo=presentacion&accion=agregar", parametros, function(respuesta) {
            $("#div-pb").hide();
            $("#div-btn").show();
    ...
    $("#btn-modificar").click(function() {
        if (confirm("¿Desea modificar el registro?")) {
            ...
            $("#div-btn").hide();
            var parametros = $("#formulario").serialize();
            $.post("?modulo=presentacion&accion=modificar", parametros, function(respuesta) {
                $("#div-pb").hide();
                $("#div-btn").show();
