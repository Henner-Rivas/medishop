                ...
                <div class="card-body">
                    <form id="formulario" method="post">
                        ...
                        <div class="form-group row">
                            <label for="idpersona" class="col-sm-3 col-form-label">Proveedor</label>
                            <div class="col-sm-9">
...
<script>
    ...
    function modificar(id) {
       ...
       $("#div-tabla").hide();
        ...
        $("#btn-agregar").hide();
        $("#btn-modificar").show();
            $(".entrada").text("Editar proveedor ");


        //Limpiar el formulario
        $("#formulario").trigger("reset");
        var p = "id=" + id;
        $.get("?modulo=proveedor&accion=asignar", p, function(respuesta) {
    ...
    function eliminar(id) {
        ...
        if (confirm("¿Desea eliminar el registro?")) {
            var p = "idproveedor=" + id;
            $.post("?modulo=proveedor&accion=eliminar", p, function(respuesta) {
                try {
                    var r = jQuery.parseJSON(respuesta);
    ...
    $("#btn-mostrar-formulario-agregar").click(function() {
        ...
        $("#btn-agregar").show();
        $("#btn-modificar").hide();
                    $(".entrada").text("Agregar proveedor");
