...
if (isset($_GET['nombre']) &&  $_GET['nombre'] != "") {
    ...
    $filtros .= "  AND  unidad_medida.nombre LIKE '%$nombre%'";
}


$sql_base = "SELECT idunidad_medida, nombre as nombre FROM unidad_medida 
            where true $filtros
            ...
            while ($mostrar = mysqli_fetch_array($result)) {
                ...
                <tr>
                    ...
                    <td style="text-align: center;">
                        <button type="button" class="btn btn-sm btn-primary" onclick="modificar('<?php echo $mostrar['idunidad_medida'] ?>')">
                            <i class="fas fa-edit"></i>
                        </button>


                        <button type="button" class="btn btn-sm btn-danger" onclick="eliminar('<?php echo $mostrar['idunidad_medida'] ?>')">
