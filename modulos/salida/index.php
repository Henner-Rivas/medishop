...
<script>
      ...
      function mover_pagina(pagina) {
        ...
        $("#listado").load("?modulo=salida&accion=listar",parametros);
    }
    ...
    function modificar(id) {
       ...
       $("#div-tabla").hide();
        ...
        $("#btn-agregar").hide();
        $("#btn-modificar").show();
            $(".entrada").text("Editar fecha de salida ");


        //Limpiar el formulario
        $("#formulario").trigger("reset");
        var p = "id=" + id;
        $.get("?modulo=salida&accion=asignar", p, function(respuesta) {
    ...
    function eliminar(id) {
        ...
        if (confirm("¿Desea eliminar el registro?")) {
            var p = "idsalida=" + id;
            $.post("?modulo=salida&accion=eliminar", p, function(respuesta) {
                try {
                    var r = jQuery.parseJSON(respuesta);
    ...
    $("#btn-mostrar-formulario-agregar").click(function() {
        ...
        $("#btn-agregar").show();
        $("#btn-modificar").hide();
                    $(".entrada").text("Agregar fecha de salida");
    ...
    $("#btn-agregar").click(function() {
        ...
        $.post("?modulo=salida&accion=agregar", parametros, function(respuesta) {
            $("#div-pb").hide();
            $("#div-btn").show();
    ...
    $("#btn-modificar").click(function() {
        if (confirm("¿Desea modificar el registro?")) {
            ...
            $("#div-btn").hide();
            var parametros = $("#formulario").serialize();
            $.post("?modulo=salida&accion=modificar", parametros, function(respuesta) {
                $("#div-pb").hide();
                $("#div-btn").show();
