...
if (isset($_GET['fecha']) &&  $_GET['fecha'] != "") {
    ...
    $filtros .= "  AND  salida.fecha LIKE '%$fecha%'";
}


$sql_base = "SELECT idsalida, fecha as fecha FROM salida 
            where true $filtros
 ...
 <tr id="tr-filtros"  <?php echo $filtros !='' ?  '' : 'style=
  ...
  "display: none;" ' ?> >  
            <th scope="col"> </th>
                ...
                <th scope="col">
                    <input type="text" name="fecha" class="form-control form-control-sm" value="<?php echo isset($_GET['fecha']) ? $_GET['fecha'] : ""  ?>" /></th>
            ...
            while ($mostrar = mysqli_fetch_array($result)) {
                ...
                <tr>
                    ...
                    <td style="text-align: center;">
                        <button type="button" class="btn btn-sm btn-primary" onclick="modificar('<?php echo $mostrar['idsalida'] ?>')">
                            <i class="fas fa-edit"></i>
                        </button>


                        <button type="button" class="btn btn-sm btn-danger" onclick="eliminar('<?php echo $mostrar['idsalida'] ?>')">
