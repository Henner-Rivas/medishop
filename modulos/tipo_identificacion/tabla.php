...
if (isset($_GET['nombre']) &&  $_GET['nombre'] != "") {
    ...
    $filtros .= "  AND  tipo_identificacion.nombre LIKE '%$nombre%'";
}




$sql_base = "SELECT idtipo_identificacion,
            ...
            while ($mostrar = mysqli_fetch_array($result)) {
                ...
                <tr>
                    ...
                    <td style="text-align: center;">
                        <button type="button" class="btn btn-sm btn-primary" onclick="modificar('<?php echo $mostrar['idtipo_identificacion'] ?>')">
                            <i class="fas fa-edit"></i>
                        </button>


                        <button type="button" class="btn btn-sm btn-danger" onclick="eliminar('<?php echo $mostrar['idtipo_identificacion'] ?>')">
