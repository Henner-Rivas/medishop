            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form id="formulario" method="post">
                        <input type="hidden" name="idtipo_identificacion" id="idtipo_identificacion"/>
                        
                          <div class="form-group row">
                            <label for="nombre" class="col-sm-3 col-form-label">Tipo de identificación</label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="nombre" name="nombre" placeholder="Tipo de identificación">
                            </div>
                        </div>
                    </form>
                    <hr />
...
<script>
    ...
    function modificar(id) {
       ...
       $("#div-tabla").hide();
        ...
        $("#btn-agregar").hide();
        $("#btn-modificar").show();
            $(".entrada").text("Editar tipo de identificación");


        //Limpiar el formulario
        $("#formulario").trigger("reset");
        var p = "id=" + id;
        $.get("?modulo=tipo_identificacion&accion=asignar", p, function(respuesta) {
            ...
            $("#idtipo_identificacion").val(r.idtipo_identificacion);
            $("#nombre").val(r.nombre);
    ...
    function eliminar(id) {
        ...
        if (confirm("¿Desea eliminar el registro?")) {
            var p = "idtipo_identificacion=" + id;
            $.post("?modulo=tipo_identificacion&accion=eliminar", p, function(respuesta) {
                try {
                    var r = jQuery.parseJSON(respuesta);
    ...
    $("#btn-mostrar-formulario-agregar").click(function() {
        ...
        $("#btn-agregar").show();
        $("#btn-modificar").hide();
                    $(".entrada").text("Agregar tipo de identificación");
