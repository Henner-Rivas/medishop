                ...
                <div class="card-body">
                    <form id="formulario" method="post">
                        ...
                        <div class="form-group row">
                            <label for="fecha_pedido" class="col-sm-3 col-form-label">Fecha del pedido</label>
                            <div class="col-sm-9">
                                <input type="date" class="form-control" id="fecha_pedido" name="fecha_pedido" placeholder="fecha del pedido">
                            </div>
                        </div>
                                ...
                                <select class="form-control " id="idproveedor" name="idproveedor">
                                  ...
                                  ";
                                    ...
                                    while ($rw1 = mysqli_fetch_assoc($rs1)) {
                                        ...
                                        echo "<option value='$rw1[idproveedor]'>$rw1[proveedor]</option>";
                                    }
                                    ?>
                                </select>
                            </div>
...
<script>
    ...
    function modificar(id) {
       ...
       $("#div-tabla").hide();
        ...
        var p = "id=" + id;
        $.get("?modulo=pedido&accion=asignar", p, function(respuesta) {
            ...
            $("#idpedido").val(r.idpedido);
             $("#fecha_pedido").val(r.fecha_pedido);
    ...
    function eliminar(id) {
        ...
        if (confirm("¿Desea eliminar el registro?")) {
            var p = "idpedido=" + id;
            $.post("?modulo=pedido&accion=eliminar", p, function(respuesta) {
                try {
                    var r = jQuery.parseJSON(respuesta);
