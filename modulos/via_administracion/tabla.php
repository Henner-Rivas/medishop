...
if (isset($_GET['nombre']) &&  $_GET['nombre'] != "") {
    ...
    $filtros .= "  AND  via_administracion.nombre LIKE '%$nombre%'";
}


$sql_base = "SELECT idvia_administracion, nombre as nombre FROM via_administracion 
            where true $filtros
            ...
            while ($mostrar = mysqli_fetch_array($result)) {
                ...
                <tr>
                    ...
                    <td style="text-align: center;">
                        <button type="button" class="btn btn-sm btn-primary" onclick="modificar('<?php echo $mostrar['idvia_administracion'] ?>')">
                            <i class="fas fa-edit"></i>
                        </button>


                        <button type="button" class="btn btn-sm btn-danger" onclick="eliminar('<?php echo $mostrar['idvia_administracion'] ?>')">
