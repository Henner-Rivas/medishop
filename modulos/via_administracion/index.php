            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form id="formulario" method="post">
                        <input type="hidden" name="idvia_administracion" id="idvia_administracion"/>
                        
                     <div class="form-group row">
                            <label for="nombre" class="col-sm-3 col-form-label">Via de administración</label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="nombre" name="nombre" placeholder="Via de administración">
                            </div>
                        </div>
...
<script>
      ...
      function mover_pagina(pagina) {
        ...
        $("#listado").load("?modulo=via_administracion&accion=listar",parametros);
    }
    ...
    function modificar(id) {
       ...
       $("#div-tabla").hide();
        ...
        $("#btn-agregar").hide();
        $("#btn-modificar").show();
            $(".entrada").text("Editar via de administración ");


        //Limpiar el formulario
        $("#formulario").trigger("reset");
        var p = "id=" + id;
        $.get("?modulo=via_administracion&accion=asignar", p, function(respuesta) {
            ...
            $("#idvia_administracion").val(r.idvia_administracion);
            $("#nombre").val(r.nombre);
    ...
    function eliminar(id) {
        ...
        if (confirm("¿Desea eliminar el registro?")) {
            var p = "idvia_administracion=" + id;
            $.post("?modulo=via_administracion&accion=eliminar", p, function(respuesta) {
                try {
                    var r = jQuery.parseJSON(respuesta);
    ...
    $("#btn-mostrar-formulario-agregar").click(function() {
        ...
        $("#btn-agregar").show();
        $("#btn-modificar").hide();
                    $(".entrada").text("Agregar via de asministración");
    ...
    $("#btn-agregar").click(function() {
        ...
        $.post("?modulo=via_administracion&accion=agregar", parametros, function(respuesta) {
            $("#div-pb").hide();
            $("#div-btn").show();
    ...
    $("#btn-modificar").click(function() {
        if (confirm("¿Desea modificar el registro?")) {
            ...
            $("#div-btn").hide();
            var parametros = $("#formulario").serialize();
            $.post("?modulo=via_administracion&accion=modificar", parametros, function(respuesta) {
                $("#div-pb").hide();
                $("#div-btn").show();
