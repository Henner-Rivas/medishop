<div class="right_col" role="main">
     ...
     <div class="container mt-4" style="max-width:700px">
        <div class="card">
            ...
            <div class="card-body">
                <form id="formulario" method="post" target="_blank" action="?modulo=reportes_producto_salida&accion=descarga">
                            <div class="form-group row">
                            <label for="fecha_inicio" class="col-sm-3 col-form-label">Fecha salida desde</label>
                            <div class="col-sm-9">
                                <input type="date" class="form-control" id="fecha_inicio" name="fecha_inicio" placeholder="fecha del pedido desde">
                            </div>
                        </div>
       <div class="form-group row">
                            <label for="fecha_hasta" class="col-sm-3 col-form-label">Fecha salida hasta</label>
                            <div class="col-sm-9">
