<div class="right_col" role="main">
     ...
     <div class="container mt-4" style="max-width:700px">
        <div class="card">
            ...
            <div class="card-body">
                <form id="formulario" method="post" target="_blank" action="?modulo=reporte_empleado&accion=descarga">
                             <div class="form-group row">
                            <label for="cargo" class="col-sm-3 col-form-label">Nombre cargo</label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="cargo" name="cargo" placeholder="Nombre cargo">
